          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{ !empty($admin->avatar) && $admin->avatar != '[]' ? asset(json_decode($admin->avatar)[0]->thumb) : asset('public/vendor/admin/img/avatar_default.jpg') }}" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="{{ url('admin/manager/update/'.$admin->id) }}" class="btn btn-default btn-flat">Trang cá nhân</a>
                    </div>
